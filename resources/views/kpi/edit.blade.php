...
@section('title'){{ 'Kpi Edit' }}@endsection
@section('header.css')
    <style>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Kpi Edit</li>
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="fk_type_id" id="type" onchange="typeChange()">
                                                ...
                                                <option value="{{$types->id}}" @if($kpi->fk_type_id === $types->id) selected @endif>{{$types->type_name}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="fk_subtype_id" id="subtype" onchange="subTypeChange()">
                                                @foreach ($sub_type as $sType)
                                                <option value="{{$sType->id}}" @if($kpi->fk_subtype_id === $sType->id) selected @endif >{{$sType->subtype_name}}</option>    
                                                @endforeach                                           
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="fk_subtype_topic_id" id="subtypeTopic">
                                                @foreach ($subtype_topic as $topic)
                                                <option value="{{$topic->id}}" @if($kpi->fk_subtype_topic_id === $topic->id) selected @endif >{{$topic->topic_name}}</option>    
                                                @endforeach                                              
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="date" name="date" type="date" placeholder="Date" value="{{$kpi->date}}" required>
