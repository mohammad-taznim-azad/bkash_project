...
@section('title'){{ 'Kpi Type Edit' }}@endsection
@section('header.css')
    <style>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form-wizard" action="{{ route('kpi_type.update', $kpi->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row ">
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                            <label for="typeName">Type Name</label><span class="text-danger">*</span>
                                            <input class="form-control" id="typeName" name="type_name" type="text" placeholder="Type Name" value="{{ @$kpi->type_name }}" required>
