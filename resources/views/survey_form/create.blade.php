                                ...
                                <div class="row ">
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="title" name="title" type="text" placeholder="Country Name" value="{{ old('title') }}" required>
                                        ...
                                        <div class="row" id="optionArea">
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input class="form-control" id="option" name="description[]" type="file" placeholder="Enter Option">
                                        ...
                                        <div class="text-end btn-mb">
                                            <button class="btn btn-secondary" type="button"><a class="text-white" href="{{ route('country.show') }}">Cancel</a></button>
