                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" class="form-control h-55" placeholder="Topic Name" id="c_productName" value="" name="topic_name">
                                    </div>
                                </div>                             
                            </div>
...
$('#topicTable').DataTable({
    ...
    columns: [
        ...
        {title: 'Action', className: "text-center", data: function (data) {
                return '<a title="edit" class="btn btn-warning btn-sm" data-panel-id="' + data.id + '" onclick="editSubType(this)"><i class="fa fa-edit"></i></a>'+
                    ' <a title="delete" class="btn btn-danger btn-sm" data-panel-id="' + data.id + '" onclick="deleteSubType(this)"><i class="fa fa-trash"></i></a>';
